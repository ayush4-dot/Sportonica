...
-- schema_full.sql/add_columns.sql and fix_role_escalation.sql.
--
-- Idempotent (drop-and-recreate policies + create-or-replace functions,
-- all guarded). Not destructive: no data is touched — it only tightens
-- RLS policies, adds guard triggers, and revokes a grant.
--
-- Closes these holes:
