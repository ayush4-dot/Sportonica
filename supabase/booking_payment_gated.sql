...
-- payments.sql / booking_phone.sql / book_court_dedupe.sql.
--
-- Idempotent (all create-or-replace, triggers dropped-then-created).
-- Not destructive: replaces book_court() in place and adds functions +
-- triggers — no schema drop, no data change.
--
-- Model:
