...
// supabase/venues/booking_payment_gated.sql.
...
//   2. court_busy_slots() RPC (supabase/venues/booking_payment_gated.sql).
...
async function fetchBusy(
  ...
  console.warn(
    "[availability] can't see other players' bookings — set SUPABASE_SERVICE_ROLE_KEY or apply supabase/venues/booking_payment_gated.sql. Showing RLS-limited availability.",
  );
