...
const CSS = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── sport panels ── */
  .p-panel { position:relative; min-height:auto; overflow:hidden; padding:88px 0; }
  .p-panel-bg { position:absolute; inset:0; display:flex; align-items:center; justify-content:center; font-size:40vw; line-height:1; opacity:0.05; pointer-events:none; user-select:none; }
  ...
  .p-games { position:relative; z-index:2; padding:36px 56px 0; display:grid; grid-template-columns:repeat(auto-fill, minmax(260px,1fr)); gap:16px; }
