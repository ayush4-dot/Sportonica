    ...
    <div className="play has-sitenav">
      <div className="play-wrap" style={{ maxWidth: 760 }}>
        <div className="bk-panel">
          ...
          <p className="hint" style={{ marginBottom: 28 }}>Last updated: 17 August 2026</p>
          ...
          <Section title="Who we share it with">
            <ul>
              ...
              <li><b>Other users</b> — a host sees an approved player&apos;s name and phone; a player sees a host&apos;s payment QR and phone once approved. Venue owners see bookings made at their venue.</li>
            </ul>
          ...
          <Section title="Contact">
            <p>
              ...
              <a href="mailto:support@khelamna.com" style={{ color: "var(--sodium)" }}>support@khelamna.com</a>.
            </p>
          </Section>
