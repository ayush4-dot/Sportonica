...
import { getDeletionContext } from "@/lib/auth/deleteAccount";
...
export default async function SecurityPage() {
  const [profile, deletionContext] = await Promise.all([getMyProfile(), getDeletionContext()]);
  if (!profile || !deletionContext) redirect("/login?redirect=/profile/security");
